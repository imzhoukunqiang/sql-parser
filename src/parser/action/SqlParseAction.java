...
public class SqlParseAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (Strings.isNotEmpty(parseResult.getResult())) {
            ...
            showPopupBalloon(e.getData(PlatformDataKeys.EDITOR),
                             parseResult.getResult(),
                             messageType,
                             "Sql has been copied to the clipboard");
        }
    }
    ...
    private void showPopupBalloon(final Editor editor, final String result, MessageType messageType, String title) {
        ApplicationManager.getApplication().invokeLater(() -> {
            ...
            Balloon balloon = factory.createHtmlTextBalloonBuilder(StringEscapeUtils.escapeHtml4(result),
                                                                   messageType,
                                                                   null)
                    .setFadeoutTime(5000)
                    .setTitle(title)
